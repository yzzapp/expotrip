...
+ (NSString*) createEnvelope: (NSString*) method forNamespace: (NSString*) ns forParameters: (NSString*) params withHeaders: (NSDictionary*) headers
{
	...
	[s appendFormat: @"<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" >"];
    ...
    NSString *nameSpace = [NSString stringWithFormat:@"Request xmlns=\"%@\"",ns];
	[s appendFormat: @"<%@>%@</%@>", nameSpace,[params stringByReplacingOccurrencesOfString:@"&" withString:@"&amp;"], method];
	[s appendString: @"</soap:Body>"];
